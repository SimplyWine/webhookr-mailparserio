...
describe Webhookr::Mailparserio::Adapter do
  ...
  describe "the class" do
    ...
    subject { Webhookr::Mailparserio::Adapter }
  ...
  describe "the instance" do
    ...
    subject { Webhookr::Mailparserio::Adapter.new }
  ...
  describe "it's response" do
    before do
      @event_type = "unsubscribe"
      @adapter = Webhookr::Mailparserio::Adapter.new
    end
    ...
    it "should return the correct service name" do
      assert_equal(Webhookr::Mailparserio::Adapter::SERVICE_NAME, subject.service_name)
    end
